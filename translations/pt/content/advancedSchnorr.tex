...
transacções activas na versão 16 do protocolo. Esta ordem permite-nos ver o
mecanismo a crescer sem confundir história com consenso actual.
...
donos. A ideia nasceu no trabalho de Rivest, Shamir e Tauman
...
anel de desafios será a engrenagem das construções seguintes.
...
O tamanho \(n\) é apenas o conjunto de anonimidade criptográfico máximo. Se
os membros forem escolhidos de maneira reconhecível ou informação externa
excluir alguns deles, a ambiguidade efectiva será menor. Para \(n=1\), SAG
...
\footnote{Na revisão Monero
\texttt{3646f648db57f60cca86430e25a635d19fa9b92a}, CLSAG é admitida desde a
