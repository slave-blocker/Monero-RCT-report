...
\begin{enumerate}
    ...
    Descarregue a versão para o seu sistema operativo e extraia o arquivo.
...
\begin{itemize}
 ...
 \ref{sec:one-time-addresses}. O alvo histórico não tem a etiqueta de
 visualização obrigatória nas saídas v16.
 ...
 \]
 Nenhum dos lados revela os montantes individuais; a igualdade apenas exclui
 criação ou destruição oculta de valor para além da taxa.
\end{itemize}
