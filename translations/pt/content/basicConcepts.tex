...
Em 1989, Claus-Peter Schnorr publicou um protocolo interactivo de identificação
que se tornou fundamental \cite{schnorr-signatures}; Maurer generalizou esta
família de provas em 2009 \cite{simple-zk-proof-maurer}. O protocolo permite a
...
é a intuição precisa de que a conversa não revela informação adicional sobre
...
\footnote{Podemos imaginar que alguém copia o estado de um computador depois
de este escolher \(\alpha\) e apresenta um desafio diferente a cada cópia. Nas
provas de segurança, esta imagem está próxima da técnica de ``rebobinar'' o
provador.}
...
Já não há uma conversa: o provador calcula o desafio localmente e publica uma
...
Bernstein e colaboradores \cite{Bernstein2008, Bernstein2012, Bernstein2007}.
...
\cite{Bernstein_chacha,chacha-irtf}, usada pela implementação Monero para
cifrar\marginnote{src/wallet/ ringdb.cpp} certos dados sensíveis da carteira.}
...
and Technology, \url{https://www.nist.gov/}}, ficou associado a uma potencial
porta de trás baseada nos seus parâmetros elípticos \cite{hales2014nsa}. A
