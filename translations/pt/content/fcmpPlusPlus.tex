...
\begin{align*}
 \underbrace{L_6=(O_6,I_6,C_6)}_{\text{posição secreta }2}
 \quad\in\quad
 \underbrace{P_1}_{\substack{\text{pai de }L_6\\
                              \text{filho da raiz}}}
 \quad\in\quad
 \underbrace{\mathcal R_{\rm tree}}_{\substack{P_1\text{ na}\\
...
\(j\) deste pai»:
\begin{align*}
 \text{primeiro nível:}&\quad X_j=L_j=(O_j,I_j,C_j),\\
 \text{níveis seguintes:}&\quad X_j=P_j.
\end{align*}
...
\begin{tikzpicture}[
 ...
 \node[treebox,fill=blue!12] (root)
   {\(\mathcal R_{\rm tree}=\operatorname{Com}(P_0,P_1,P_2,P_3)\)};
 \node[treebox,below=of root,fill=green!18] (c1)
   {\(P_1=\operatorname{Com}(L_4,L_5,L_6,L_7)\)\\
...
\begin{align*}
 \widetilde L_6
   &\longleftrightarrow
     L_6=(O_6,I_6,C_6)\in\boxed{P_1},\\
 \widehat P_1
   &\longleftrightarrow
     \boxed{P_1}\in\mathcal R_{\rm tree},\\
 \widehat{\mathcal R}
   &\longleftrightarrow
     \mathcal R_{\rm tree}.
\end{align*}
