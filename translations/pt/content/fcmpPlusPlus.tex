...
\begin{align*}
 ...
 \qquad \ell\geq1.
\end{align*}
Um tal ponto ocupa duas coordenadas escalares. Um pai que guarda \(m\) filhos pode ser
...
\end{align}
O pai é um único ponto obtido por uma combinação linear das coordenadas de
todos os filhos.
...
\begin{align*}
 ({}_{0}X_0,{}_{0}X_1,{}_{0}X_2,{}_{0}X_3)
   &=(L_4,L_5,L_6,L_7),& i_0&=2,\\
 ({}_{1}X_0,{}_{1}X_1,{}_{1}X_2,{}_{1}X_3)
...
\begin{align}
 P_{\rm pai}
   &=\sum_{j=0}^{m-1}{}_{\ell}x_jG_j^x
     +\sum_{j=0}^{m-1}{}_{\ell}y_jG_j^y+r_\ell H_{\rm pai},
...
Para \(\ell\geq1\), as testemunhas são as coordenadas dos filhos, a abertura
\(r_\ell\), a posição \(i_\ell\) e o cegamento \(\delta_\ell\). O circuito
...
\(P_{\rm pai}\) é um ponto numa curva, mas as suas coordenadas são elementos do
