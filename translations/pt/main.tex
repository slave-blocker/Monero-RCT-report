\documentclass[letterpaper,12pt,english,oneside,onecolumn,final,openany]{report}

%Primary packages
\usepackage{fancyvrb}

% Typewriter braces in FancyVerb use the standard Computer Modern symbol font.
\DeclareFontShape{OT1}{cmtt}{bx}{n}{<-> ssub * cmtt/m/n}{}
\DeclareFontFamily{OMS}{cmtt}{\skewchar\font 48}
...
\include{content/randomX}
\include{content/dandelion}
\include{content/fcmpPlusPlus}
\includepdf[pages=1,fitpaper=true,pagecommand={\thispagestyle{empty}}]{posters/fcmp-transaction/poster.pdf}
\include{content/dlogRelations}
...
\shipout\vbox to \paperheight{%
  \offinterlineskip
  \hbox to \paperwidth{%
    \includegraphics[width=\paperwidth,height=\paperheight]{front/figures/monerochan-autumn-porto-v13-final.png}%
    \hss
  }%
  \vss
}%
